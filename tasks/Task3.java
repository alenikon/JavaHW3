...
public class Task3 {
    public static void run() {
        ...
        System.out.println("Найти минимальное, максимальное и среднее арифметическое этого списка.");
        System.out.println("Список —> " + arrayToString(wrkArray));
        System.out.println("Максимальное число —> " + arrayMax(wrkArray)
                + "\tМинимальное число —> " + arrayMin(wrkArray)
                + "\tСреднее арифметическое —> " + arrayAverage(wrkArray));
