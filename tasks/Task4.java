...
public class Task4 {
    public static void run() {
        System.out.println("Реализовать разность массивов и симметрическую разность.");
        int[] wrkArray1 = new int[5];
        int[] wrkArray2 = new int[7];

        wrkArray1 = fillArray(wrkArray1);
        wrkArray2 = fillArray(wrkArray2);
        System.out.println("Массив №1 —>\t\t" + arrayToString(wrkArray1));
        System.out.println("\nМассив №2 —>\t\t" + arrayToString(wrkArray2));
        ...
        System.out.println("\nРазность между первым и вторым —>\t\t" + arrayToString(arrDiffOne)
                + "\n\nРазность между вторым и первым —>\t\t" + arrayToString(arrDiffTwo)
